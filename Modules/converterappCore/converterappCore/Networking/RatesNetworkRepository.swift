...
public final class RatesNetworkRepository: RatesRepositoryProtocol {
  private enum Constants {
    static let dateFormat = "yyyy-MM-dd"
  }
  
  var currenciesCache: CurrenciesCacheProtocol? = DependencyProvider().container.resolve(CurrenciesCacheProtocol.self)
  ...
  public func getRates(periodicity: Int = 0, completion: @escaping ([Currency]) -> Void) {
  ...
  public func getCurrencyDynamics(currencyID: Int, startDate: Date, endDate: Date, completion: @escaping ([Currency]) -> Void) {
